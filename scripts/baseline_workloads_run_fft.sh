...
M5OUT_DIR=$WORKLOAD_DIR/m5out_${WORKLOAD_NAME}_baseline
RAW_TRACE=$WORKLOAD_DIR/${WORKLOAD_NAME}_log_raw_baseline_trace
DRAMSIM_TRACE=$WORKLOAD_DIR/${WORKLOAD_NAME}_dramsim3_baseline.trace

DRAMSIM_RESULTS_DIR=$WORKLOAD_DIR/dramsim_results_baseline
...
gcc -O0 \-nostdlib -static -ffreestanding -fno-exceptions -fno-rtti \
