g++ -O0 \-nostdlib -static -ffreestanding -fno-exceptions -fno-rtti -fno-stack-protector -no-pie /ezh/workloads/graph_workloads/graph_coarsening.cpp \-I/ezh/gem5/include \-L/ezh/gem5/util/m5/build/x86/out -lm5 -o graph_coarsening
...
do
    if [ "$i" -ne 0 ]; then
        python3 /ezh/scripts/rewrite_dramsim3_bankshift.py --indir /ezh/workloads/graph_workloads/chunk_traces/graph_coarsening_trace_chunks_bitshift_0/ --outdir /ezh/workloads/graph_workloads/chunk_traces/graph_coarsening_trace_chunks_bitshift_$i --bank-count 16 --bank-lsb 0 --bank-bit-shift $i --iter-set 5
    fi
